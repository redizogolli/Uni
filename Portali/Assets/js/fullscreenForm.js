...
;( function( window ) {
	...
	FForm.prototype._addControls = function() {
		...
		this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', inner : 'VAZHDO', appendTo : this.ctrls } );
	...
	FForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			case 'NOVAL' : 
				message = 'Ju lutemi të plotësoni fushën përpara se të vazhdoni!';
				break;
			case 'INVALIDEMAIL' : 
				message = 'Ju lutemi të vendosni kredencialet tuaja!';
				break;
			// ...
		};
