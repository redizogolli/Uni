<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kontakt.aspx.cs" Inherits="Portali.Student.Kontakt" %>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
                        <h1 id="Titull" runat="server" class="page-title">Kontakt dhe Suport</h1> </div>
                </div>
       ...
       <div class="container" style="width:auto;">
        ...
        <div class="col-md-4">
            ...
            <ul style="text-align:center; -webkit-padding-start: 15px;">
                    <p><asp:Hyperlink runat="server" href="http:\\www.unitir.edu.al">UNIVERSITETI I TIRANËS</asp:Hyperlink></p>
                    <p><asp:Hyperlink runat="server" href="http:\\www.fshn.edu.al">FAKULTETI I SHKENCAVE TË NATYRËS</asp:Hyperlink></p>
                    <p><asp:Hyperlink runat="server" href="http:\\www.arsimi.gov.al">MINISTRIA E ARSIMIT</asp:Hyperlink></p>
                    <p><asp:Hyperlink runat="server" href="http://37.139.119.36:81/orari/">ORARI MËSIMOR - FSHN</asp:Hyperlink></p>
           </ul>
        </div>
        <div class="col-md-4">
