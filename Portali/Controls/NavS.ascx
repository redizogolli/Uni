 <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NavS.ascx.cs" Inherits="Portali.Controls.NavS" %>
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <asp:Hyperlink runat="server" Cssclass="logo" NavigateUrl="../Student/Njoftimet.aspx">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right" style="margin-bottom: -9px;">
                    ...
                    <li>
                      <asp:Hyperlink runat="server" class="profile-pic" NavigateUrl="../Student/Profili.aspx"><asp:Image ID="Foto_Profil" runat="server" CssClass="img-circle" Width="35" Height="35" /><b class="hidden-xs"><%= Session["UserID"] %></b></asp:Hyperlink>
                    </li>
                </ul>
            </div>
        </nav>