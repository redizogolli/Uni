<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NavP.ascx.cs" Inherits="Portali.Controls.NavP" %>
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                   <asp:Hyperlink runat="server" Cssclass="logo" NavigateUrl="../Pedagog/Shto_Njoftim.aspx">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right" style="margin-bottom: -9px;">
                   ...
                   <form action="../logout.aspx" method="post"><button type="submit" style="margin-right: 10px;margin-top: 13px;margin-bottom: 8px;" class="btn btn-default navbar-btn navbar-link">Dilni</button></form>
                    ...
                    <li>
                          <asp:Hyperlink runat="server" class="profile-pic" NavigateUrl="../Pedagog/Profili.aspx"> <asp:Image ID="Foto_Profil" runat="server" CssClass="img-circle" Width="35" Height="35"/><b class="hidden-xs"><%= Session["UserID"] %></b></asp:Hyperlink>
                    </li>
                </ul>
            </div>
        </nav>